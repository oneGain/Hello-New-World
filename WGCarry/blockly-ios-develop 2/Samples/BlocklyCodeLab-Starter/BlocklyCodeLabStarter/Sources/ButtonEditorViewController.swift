...
/// The main Blcokly editor.
    private var workbenchViewController:WorkbenchViewController = {
        ...
        // Load default blocks into workbench`s block factory 加载默认的区块到工作区的区块工厂
        ...
        do {
            ...
            if let bundlePath = Bundle.main.path(forResource: toolboxPath, ofType: nil){
                ...
                print("Cloud not load toolbox XML from '\(toolboxPath)'")
            }
        }catch let error {
  ...
  override func viewDidLoad() {
    ...
    // Add editor to this view controller 添加编辑器到这个界面控制器
