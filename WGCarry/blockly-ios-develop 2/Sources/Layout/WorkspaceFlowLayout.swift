...
@objcMembers public final class WorkspaceFlowLayout: WorkspaceLayout {
  ...
  public override func performLayout(includeChildren: Bool) {
    ...
    // Update relative position/size of blocks. We iterate through workspaceFlow.items instead of 更新block的尺寸
    // self.blockGroupLayouts, since we need to take into account gap information.  我们需要拿到间隙信息
